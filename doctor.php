...
<a class="logo-mobile" href="index.html"><img src="imgs/doctor_logo.png" alt=""></a>
    ...
    <div class="collapse navbar-collapse"id="myNavbar">
          <a class="none" href="index.html"><img src="imgs/doctor_logo.png" alt=""></a>
  ...
  <div class="container bg-1";>
    <div class="row">
      ...
      <div class="col-sm-6" style="padding-top:70px">
        <form class="form" name="doc_login" method="post" action="" onsubmit="return validatestaff()">
          <?php
foreach($success as $ss ){
  echo "<P style='color:red;margin-left:20px;'>$ss</P>";
          ...
          <div class="form-group text-center">
               <input type="submit"  value="Login" name="doc_login"class="btn btn-success btn-lg">
          </div>
        </form>
      </div>
      <div class="col-sm-3">
