      ...
      <div style='color:black;'>
          <div class='row'>
              ...
              <div class='col-lg-8'>
                  ...
                  <h5 style='color:green;'class='text-center'>Government Schemes</h5>
                  <form action='payment.php' method='post'>
                  <input type='hidden' name='phone' value=".$row['phone'].">
                  <input type='hidden' name='total' value=".$row['total_fee'].">
                  <input type='submit' value='50% scheme' name='scheme_1' style='float:left'>
                  </form>
                  <form action='payment.php' method='post'>
                  <input type='hidden' name='phone' value=".$row['phone'].">
                  <input type='hidden' name='total' value=".$row['total_fee'].">
                  <input type='submit' value='100% scheme' name='scheme_2' style='float:right'>
                  </form>
                  <a href='cas_main.php'>click ok</a>
                  </div>
                  <div class='col-lg-6'>
                  ...
                  <h4><b>Due Amount : </b>".$row['due_amount']."\-</h4>
                    ...
                    <form action='payment.php' method='post'>
                    <input type='number' name=paid_amount placeholder='AMOUNT' required>
                    <input type='hidden' name='phone' value=".$row['phone'].">
                    <input type='hidden' name='old_pay' value=".$row['paid_amount'].">
                    <input type='submit' value='submit' name='amount'>
                    </form>
                  </div>
                  </div>
              </div>
