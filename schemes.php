                ...
                ?>
                     <div class="row">
                       <div class="col-lg-12">
                         ...
                         <div class="form-group">
                              <input type="text"  placeholder="Specialization/Qualification" class="form-control formcontrol" name="spequa" required>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                              <input type="password"  placeholder="Default Password" id="Default_pass" class="form-control formcontrol" name="password" required>

                         </div>
                         <div class="form-group">
                           <select class="form-control formcontrolhyd" name="job" style="color:black;">
                             <optgroup label="no.of cls" >
                 ...
                 <div class="form-group text-right">
                   <a href="cas_main.php" class="pull-left btn btn-success btn-lg">Back</a>
                          <button type="submit" value="reg_staff" name="scheme_1" class="btn btn-success btn-lg" >Register</button>
            </div>
  </form>
</div>
    </div>
